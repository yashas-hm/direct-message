...
class CustomAppTheme {
  ...
  ThemeData get light => ThemeData(
    ...
    textTheme: GoogleFonts.latoTextTheme(
      Theme.of(context).textTheme
          .apply(bodyColor: bgDark, displayColor: bgDark),
    ),
    useMaterial3: false,
    appBarTheme: AppBarTheme(
      ...
      titleTextStyle: GoogleFonts.roboto(fontSize: 30.sp, color: bgDark),
    ),
  ...
  ThemeData get dark => ThemeData(
    ...
    textTheme: GoogleFonts.latoTextTheme(
      Theme.of(context).textTheme
          .apply(bodyColor: bgLight, displayColor: bgLight),
    ),
    useMaterial3: false,
    appBarTheme: AppBarTheme(
      systemOverlayStyle: const SystemUiOverlayStyle(
      ...
      titleTextStyle: GoogleFonts.pacifico(fontSize: 30.sp, color: bgLight),
    ),
    colorScheme: ColorScheme.fromSeed(
      seedColor: blueDark,
      primary: blueDark,
